...
import logo from '/public/ImageAsset/ExamItLogo4.svg';
		...
		<Headers ref={ref}>
			<Logo>
				...
				<div style={{ paddingTop: 0 }}>
					...
					<pre style={{ fontSize: '10px', color: '#E6A3F3' }}>
						AI POWERED EXAMS
					</pre>
				</div>
			</Logo>
			<Nav>
				{props.menus?.map((menu, idx) => (
					<a
						key={`_Nav_Menu___${idx}_marker_${menu.id + 1}`}
						href={menu.link}
